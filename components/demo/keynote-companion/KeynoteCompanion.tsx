...
export default function KeynoteCompanion() {
  const { client, connected, setConfig, isTalking, spokenText } =
    useLiveAPIContext();
  ...
  useEffect(() => {
    setConfig({
      ...
      speechConfig: {
        voiceConfig: {
          // FIX: The property for voice configuration should be `voiceName`.
  ...
  return (
    <div className="keynote-companion">
      <SpeechBubble text={spokenText} isVisible={isTalking && !!spokenText} />
